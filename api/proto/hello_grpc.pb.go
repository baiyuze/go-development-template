...
const (
	UserService_VerifyToken_FullMethodName = "/proto.UserService/VerifyToken"
)
...
func (c *userServiceClient) VerifyToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) VerifyToken(context.Context, *TokenRequest) (*UserResponse, error) {
